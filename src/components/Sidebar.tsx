...
//       <aside
//         id="default-sidebar"
//         className="fixed top-0 ltr:left-0 rtl:right-0 z-40 w-80 h-screen transition-transform -translate-x-full sm:translate-x-0"
//         aria-label="Sidebar"
//       >
//         <div className="h-full px-3 py-4 overflow-y-auto  bg-bg-primary ">
